INSERT INTO COMPANY(ID, NAME) VALUES (1, 'Spartan Securities');
INSERT INTO COMPANY(ID, NAME) VALUES (2, 'Inspired Illusions');
INSERT INTO COMPANY(ID, NAME) VALUES (3, 'Spacious Minds');
...
INSERT INTO EMPLOYEE(ID, NAME, SURNAME, ADDRESS_ID, DEPARTMENT_ID) VALUES (1, 'Ullas', 'Sharma', 1, 1);
INSERT INTO EMPLOYEE(ID, NAME, SURNAME, ADDRESS_ID, DEPARTMENT_ID) VALUES (2, 'Varun', 'GN', 2, 2);
INSERT INTO EMPLOYEE(ID, NAME, SURNAME, ADDRESS_ID, DEPARTMENT_ID) VALUES (3, 'Deepak', 'Sharma', 3, 3);
